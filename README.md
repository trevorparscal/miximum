...
Composing component lists folds all component instance properties into one instance, so property conflicts are resolved by last-one-wins. Mapped components don't have this issue, but they add a level of complexity that isn't always desired. Use the approach that makes the most sense for that portion of your app.
